  ...
  return (
    <div className="nav-border p-2 w-full md:w-[70%] mt-2">
      ...
      <div className="text-sm mt-2">
        <ul>
          <li className="bg-secondary flex items-center gap-2 nav-border w-full px-2 py-[4px] cursor-pointer">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 48 48"
          ...
          <li className="flex mt-2 mb-2 items-center gap-2 nav-border w-full px-2 py-[4px] cursor-pointer">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 48 48"
          ...
          <li className="flex items-center gap-2 nav-border w-full px-2 py-[4px] cursor-pointer">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 24 24"
